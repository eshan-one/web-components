...
describe('object values', () => {
  ...
  describe('label and value paths', () => {
    ...
    it('should select first of duplicate labels manually', async () => {
      const spy = sinon.spy();
      comboBox.addEventListener('selected-item-changed', spy);
    ...
    it('should select second of duplicate labels manually', async () => {
      const spy = sinon.spy();
      comboBox.addEventListener('selected-item-changed', spy);
    ...
    it('should maintain selection on second of duplicate labels on blur', async () => {
      clickItem(comboBox, 11);
      await nextUpdate(comboBox);
